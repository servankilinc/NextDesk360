...
namespace ExpressDesk360.Model.Dtos.FSFile.Commands
{
    public class FSFileUpdateDto : IDto
    {
    ...
    public class FSFileUpdateDtoValidator : AbstractValidator<FSFileUpdateDto>
    {
        public FSFileUpdateDtoValidator()
        {
