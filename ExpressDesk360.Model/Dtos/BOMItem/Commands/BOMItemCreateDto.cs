...
namespace ExpressDesk360.Model.Dtos.BOMItem.Commands
{
    public class BOMItemCreateDto : IDto
    {
    ...
    public class BOMItemCreateDtoValidator : AbstractValidator<BOMItemCreateDto>
    {
        public BOMItemCreateDtoValidator()
        {
