...
namespace ExpressDesk360.Model.Dtos.TicketModule.TicketMovement.Commands
{
    public class TicketMovementCreateDto : IDto
    {
    ...
    public class TicketMovementCreateDtoValidator : AbstractValidator<TicketMovementCreateDto>
    {
