...
namespace ExpressDesk360.Model.Dtos.ProductionModule.CompanyProduct.Commands
{
    public class CompanyProductUpdateDto : IDto
    {
    ...
    public class CompanyProductUpdateDtoValidator : AbstractValidator<CompanyProductUpdateDto>
    {
        public CompanyProductUpdateDtoValidator()
        {
