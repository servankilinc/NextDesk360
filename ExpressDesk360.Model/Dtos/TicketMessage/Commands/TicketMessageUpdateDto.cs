...
namespace ExpressDesk360.Model.Dtos.TicketMessage.Commands
{
    public class TicketMessageUpdateDto : IDto
    {
    ...
    public class TicketMessageUpdateDtoValidator : AbstractValidator<TicketMessageUpdateDto>
    {
        public TicketMessageUpdateDtoValidator()
        {
