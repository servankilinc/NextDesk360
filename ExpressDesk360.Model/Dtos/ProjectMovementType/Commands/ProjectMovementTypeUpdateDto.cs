...
{
    public class ProjectMovementTypeUpdateDto : IDto
    {
    ...
    public class ProjectMovementTypeUpdateDtoValidator : AbstractValidator<ProjectMovementTypeUpdateDto>
    {
        public ProjectMovementTypeUpdateDtoValidator()
        {
            ...
            RuleFor(v => v.ProjectStatusId).GreaterThan(0).WithMessage("ProjectStatusId must be greater than 0");
