...
namespace ExpressDesk360.WebAPI.Controllers
{
    public class BOMItemController : BaseController
    {
        ...
        public BOMItemController(ILogger<BOMItemController> logger, IBOMItemService bOMItemService) : base(logger)
        {
        ...
        {
            var result = await _bOMItemService.GetAsync(id: id);
        ...
        {
            var result = await _bOMItemService.GetBaseAsync(id: id);
            return ToAction(result);
        }
        ...
        {
            var result = await _bOMItemService.GetListAsync(request);
            return ToAction(result);
        }
        ...
        {
            var result = await _bOMItemService.GetBaseListAsync(request);
            return ToAction(result);
        }
        ...
        {
            var result = await _bOMItemService.GetUpdateModelAsync(id: id);
            return ToAction(result);
        }

        [HttpPut]
        public async Task<IActionResult> Update(BOMItemUpdateDto request)
        {
            var result = await _bOMItemService.UpdateAsync(request);
            return ToAction(result);
        }
        ...
        {
            var result = await _bOMItemService.PaginationAsync(request);
            return ToAction(result);
        }
