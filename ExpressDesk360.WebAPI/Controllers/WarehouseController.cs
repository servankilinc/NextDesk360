...
namespace ExpressDesk360.WebAPI.Controllers
{
    public class WarehouseController : BaseController
    {
        ...
        {
            var result = await _warehouseService.GetAsync(id: id);
        ...
        {
            var result = await _warehouseService.GetBaseAsync(id: id);
            return ToAction(result);
        }
        ...
        {
            var result = await _warehouseService.GetListAsync(request);
            return ToAction(result);
        }
        ...
        {
            var result = await _warehouseService.GetBaseListAsync(request);
            return ToAction(result);
        }

        [HttpPost]
        public async Task<IActionResult> Create(WarehouseCreateDto request)
        {
        ...
        {
            var result = await _warehouseService.GetUpdateModelAsync(id: id);
            return ToAction(result);
        }

        [HttpPut]
        public async Task<IActionResult> Update(WarehouseUpdateDto request)
        {
            var result = await _warehouseService.UpdateAsync(request);
            return ToAction(result);
        }
        ...
        {
            var result = await _warehouseService.PaginationAsync(request);
            return ToAction(result);
        }
